...
public class ArcherBuilder : MonoBehaviour,IBuilder
{
    ...
    public void Build()
    {
        if (GameManager.instance.Coin>=Price)
        {
            ...
            GameObject build = Instantiate(ArcherPrefab, SelectionManager.instance.selectedBuildArea.transform.position,
                Quaternion.identity);
